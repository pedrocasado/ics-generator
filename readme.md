...
I would recommend you download the library directly from my git repository (https://github.com/pedrocasado/ics-generator) because it will always 
...
```
    $ git clone https://github.com/pedrocasado/ics-generator.git
    $ cd ics-generator
